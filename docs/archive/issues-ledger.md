> **ARCHIVE.** The full text of all 86 `TC-` findings of the Phase T campaign
> (2026-07-15 to 2026-07-30), every one of them closed. The live ledger is
> `testing/ISSUES.md`, which carries the index and is where a new finding goes.
>
> Kept for the reasoning: each entry records what the defect actually was, what
> measurement settled it, and which mechanism was changed. Several of the traps
> here are the source of the rules in `CLAUDE.md` §6.
