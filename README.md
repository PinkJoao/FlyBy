...
- **Spellbook** - spells organized by origin (class, species, feats) with prepared-spell counters, spell/pact slots, a guided "Prepare spell" picker, and support for special cases like the Warlock's Mystic Arcanum. Spells an imported character carried that no class here can cast are kept in their own "Unassigned" tab, where you can give them an origin instead of losing them.
